...
public class SBIBankAccount implements BankAccount {
	...
	static {
		...
		String ifsc=null;
		try {
                BufferedReader br=new BufferedReader(new FileReader("sbibankdetails.txt"));
                bankn=br.readLine();
                branchn=br.readLine();
		        ifsc=br.readLine();
		        System.out.println("SBI bank Account object created");
	...
	public String toString() {
		return  "SBI Bank Account details:\n"+
				"Bank name           :->"+BANKNAME+
